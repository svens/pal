...
// "oracle" to confirm pal::XtoY results
inline auto hton (uint8_t v) noexcept
{
	return v;
}
...
inline auto ntoh (uint8_t v) noexcept
{
	return v;
}
...
TEMPLATE_TEST_CASE("byte_order", "", uint8_t, uint16_t, uint32_t, uint64_t)
{
